 ...
 * @class describe
 */
class AuctionsFragment : EasyBaseFragment() {
    private var lvList: ListView? = null
    private lateinit var smartRefreshLayout: SmartRefreshLayout
    private lateinit var loadingview: EasyLoadingView
    private var page = 1
    ...
    override fun initView() {
        ...
        loadingview = findViewById(R.id.loadingview) as EasyLoadingView
    }
    ...
    private fun netData() {
        ...
        params["page"] = page
        EasyHttpManager.getInstance().getService(BoxService::class.java).apiNameAuctions(params).enqueue(object : Callback<NamesModel?> {
            ...
            override fun onFailure(call: Call<NamesModel?> , t: Throwable) {
                smartRefreshLayout.finishRefresh()
                //                loadingview.setLoadingType(EasyLoadingView.PEP_LOADING_ERROR)
