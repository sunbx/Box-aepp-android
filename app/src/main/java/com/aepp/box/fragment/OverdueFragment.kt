 ...
 * @class describe
 */
class OverdueFragment : EasyBaseFragment() {
    ...
    private fun netData() {
        ...
        params["page"] = page
        EasyHttpManager.getInstance().getService(BoxService::class.java).apiNameOver(params).enqueue(object : Callback<NamesModel?> {
